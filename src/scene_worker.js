    ...
    buildTile ({ tile }) {
        ...
        return self.awaitConfiguration().then(() => {
            ...
            if (tile.loaded !== true) {
                ...
                return new Promise((resolve, reject) => {
                    ...
                    self.loadTileSourceData(tile).then(() => {
                        ...
                        tile.loading = false;
                        tile.loaded = true;
                        Tile.buildGeometry(tile, self.config.layers, self.rules, self.styles, self.config.scene).then(keys => {
            ...
            // Tile already loaded, just rebuild
                ...
                // Build geometry
                return Tile.buildGeometry(tile, self.config.layers, self.rules, self.styles, self.config.scene).then(keys => {
